...
<body class="container-fluid">
    <div class="card-body">
        <div class="pb-4">
            <p style="margin-bottom: 0px; font-weight: bold;">QC District</p>
            <p style="margin-bottom: 0px; font-weight: bold;">qcd@gmail.com</p>
        ...
        <div class="row mt-5">
            <div class="col-xxl-6 col-6 mb-md-0 mb-2">
                ...
                <p style="margin-bottom: 0px;">Sample District
                    Only</p>
            </div>
