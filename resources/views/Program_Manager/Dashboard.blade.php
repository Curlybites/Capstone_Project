...
>
  <head>
    ...
    <title>Health Department | Dashboard</title>
      ...
      <div class="layout-container">
        ...
        <div class="app-brand d-flex align-items-center justify-content-center p-3">
          <a href="Dashboard.php" class="app-brand-link ">
            <img src="../assets/img/qc.png" width="100$" class="">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item ">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Statistics</div>
              </a>
              ...
              <div class="col-lg-8 mb-4 order-0">
                <div class="card">
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        <h5 class="card-title text-primary">Welcome to Program Manager Dashboard John! 🎉</h5>
                        <p class="mb-4">
